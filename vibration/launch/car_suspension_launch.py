...
def generate_launch_description():
	...
	model_urdf_file_path = 'rsc/urdf/car_body_only_front.urdf'
	world_file_path = 'worlds/car_simulation.world'
	...
	default_model_path = os.path.join(pkg_share, model_urdf_file_path)
